...
def makemap():
    print('Преветствуем вас в редакторе карт для игры The Abyssal Conundrum, настоятельно рекомендуем изучить файл README. Если после ввода вам кажется, что программа не работает, посмотрите, не свернулась ли она.')
    pygame.init()
